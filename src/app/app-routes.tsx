...
const RoadmapfromrustdevtosolanadevFeature = lazy(() => import('../components/roadmapfromrustdevtosolanadev/roadmapfromrustdevtosolanadev-feature'))
const DashboardFeature = lazy(() => import('../components/dashboard/dashboard-feature'))

const links: { label: string; path: string }[] = [
  { label: 'Account', path: '/account' },
  { label: 'Clusters', path: '/clusters' },
  { label: 'Roadmapfromrustdevtosolanadev Program', path: '/roadmapfromrustdevtosolanadev' },
]

const routes: RouteObject[] = [
  { path: '/account/', element: <AccountListFeature /> },
  { path: '/account/:address', element: <AccountDetailFeature /> },
  { path: '/roadmapfromrustdevtosolanadev', element: <RoadmapfromrustdevtosolanadevFeature /> },
